...
//   Updated: 2015/06/23 23:24:38 by mnguyen          ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
{
	if (grade > this->_grade_to_exec)
		throw Form::GradeTooLowException();
	if (!this->_signed)
		throw std::invalid_argument("FormNotSigned");
}
...
{
	o << rhs.getName() << ", bureaucrat grade " << rhs.getGS() << std::endl;
	return o;
}
