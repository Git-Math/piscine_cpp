...
//                                                +#+#+#+#+#+   +#+           //
//   Created: 2015/06/18 17:27:47 by mnguyen           #+#    #+#             //
//   Updated: 2015/06/18 23:31:41 by mnguyen          ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
std::string		solve_mult(std::string s)
{
	size_t i;
	size_t j;
	size_t k;
...
std::string     solve_div(std::string s)
{
    size_t i;
    size_t j;
    size_t k;
...
std::string     solve_add(std::string s)
{
    size_t i;
    size_t j;
    size_t k;
...
std::string     solve_sous(std::string s)
{
    size_t i;
    size_t j;
    size_t k;
...
std::string		solve_parenthesis(std::string s)
{
	s = solve_mult(s);
	s = solve_div(s);
	s = solve_add(s);
...
std::string		find_parenthesis(std::string s)
{
	size_t i;
	size_t j;
